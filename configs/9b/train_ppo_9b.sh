...
TAG=glm-9b-ppo-v15-ms${NUM_TRACE}_rm32-v1-approx-kl-${KL}
SAVE_DIR=/workspace/zhenyu/checkpoints/openrlhf/ppo/$TAG
mkdir -p $SAVE_DIR
...
ray job submit --address="http://127.0.0.1:8265" \
    ...
    --critic_pretrain /workspace/zhenyu/checkpoints/9b/sft/9b-sft-0526-v15/iter_0016000/chatglm-hf \
    --save_path $SAVE_DIR \
    --ckpt_path $SAVE_DIR \
    --micro_train_batch_size 4 \
    --train_batch_size $((NUM_TRACE * 128)) \
    --micro_rollout_batch_size 16 \
    --roll_out_batch_size_multiplier 4 \

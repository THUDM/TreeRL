...
DATASET="
     ...
     $DATA_DIR/subjects/pointwise/tiku_zhipu_8_2_deduped_dpo_point.jsonl,0.54
     $DATA_DIR/subjects/pointwise/afanti_and_sft_0504_point.jsonl,0.19
     $DATA_DIR/subjects/pointwise/chatglm130-240104-mid-full-22k_point.jsonl,0.1
     $DATA_DIR/subjects/ultraact.jsonl,0.05
     $DATA_DIR/subjects/pointwise/code_public-datasets_apps_20240524-point.jsonl,0.05
"
...
ARGS="
     ...
     --pretrain /workspace/zhenyu/checkpoints/32b/sft/32b-sft-0527-v16/iter_0016000/chatglm-hf \
